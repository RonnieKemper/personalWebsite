...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf portfolio && mkdir portfolio', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir portfolio && cp -r portfolio/* portfolio/ && rm -rf portfolio', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd portfolio && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    .connect({
      ...
      host: 'ec2-3-88-235-136.compute-1.amazonaws.com',
      username: 'ubuntu',
      privateKey: './portfolio.pem'
    })
    .then(function() {
    ...
    .then(function() {
      console.log('Creating `portfolio` folder.');
